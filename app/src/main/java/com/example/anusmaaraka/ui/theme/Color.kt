package com.example.anusmaaraka.ui.theme
...
val ThemeColor = Color(0xFFff2fbf)
val SecondaryThemeColor = Color(0xFFff62cf)
val TeritiaryThemeColor = Color(0xFF510038)
